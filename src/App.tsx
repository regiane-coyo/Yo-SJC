...
export default function App() {
  ...
  return (
    ...
    >
      ...
      {/* Global Title Bar */}
      <div className="bg-[#0a0a0d] border-b border-neutral-850 py-3.5 px-4 md:px-8 flex items-center justify-between sticky top-0 z-50 shadow-md">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xs font-bold uppercase tracking-wider text-neutral-200 font-sans">Apresentação Estratégica SJC</h1>
            <p className="text-[10px] text-neutral-500 font-light font-sans">Plano de Atração Yo Sushi SJC</p>
          </div>
        </div>
      </div>
