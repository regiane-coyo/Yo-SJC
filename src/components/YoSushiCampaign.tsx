      ...
      <div className="min-h-[300px]">
        ...
        {activeSubTab === 'influencers' && (
          <div className="max-w-4xl mx-auto space-y-6">
            <div className="bg-neutral-900/50 border border-neutral-800 p-6 md:p-8 rounded-3xl space-y-6 shadow-xl animate-in fade-in duration-200">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-neutral-800 pb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-neutral-400">Acompanhamento de propostas, orçamentos e táticas.</p>
                  </div>
                </div>
                <div className="bg-neutral-950 border border-neutral-850 px-3 py-1.5 rounded-xl text-neutral-400 text-xs font-mono text-center self-start sm:self-center">
                  <span className="text-[10px] text-neutral-500 block">Última mensagem enviada:</span>
                  <span className="font-bold text-neutral-300">27/05/2026</span>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-neutral-950 p-5 rounded-2xl border border-neutral-850 space-y-4">
                  <p className="text-sm md:text-base text-neutral-200 font-medium leading-relaxed">
                    Fechar pacote com influenciadores, já contamos os valores e fizemos sugestões:
                  </p>
                  ...
                  <div className="flex flex-col gap-4 pt-1">
                    <a 
                      ...
                      className="inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-coral-500 text-neutral-950 hover:bg-coral-400 transition-all duration-150 rounded-xl text-xs md:text-sm font-extrabold shadow-md hover:scale-[1.01] active:scale-[0.99] w-full md:max-w-md text-center"
                    >
                      <span>https://influencers-yo-sushi.vercel.app/</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-5 rounded-2xl bg-neutral-950/40 border border-neutral-900 space-y-2">
                    <div className="w-6 h-6 rounded-lg bg-coral-500/10 flex items-center justify-center text-coral-400 text-xs font-bold">1</div>
                    <h4 className="text-xs font-bold text-neutral-200 uppercase tracking-wider">Mix de Influenciadores</h4>
                    <p className="text-xs text-neutral-400 font-light leading-relaxed">
                      Sugestão de 3 mix de influencers já estruturados e mapeados para cobrir os nichos estratégicos da região.
                    </p>
                  </div>

                  <div className="p-5 rounded-2xl bg-neutral-950/40 border border-neutral-900 space-y-2">
                    <div className="w-6 h-6 rounded-lg bg-coral-500/10 flex items-center justify-center text-coral-400 text-xs font-bold">2</div>
                    <h4 className="text-xs font-bold text-neutral-200 uppercase tracking-wider">Dilema de Distribuição de Verba</h4>
                    <p className="text-xs text-neutral-400 font-light leading-relaxed">
                      Orçamento de 4K é disponibilizado mensalmente ou somente uma vez? A ideia é diluir a ida dos influencers (ex: 3 meses) para termos conteúdo rodando por mais tempo.
                    </p>
                  </div>
                </div>
              </div>
